  ...
  return (
    <div>
      ...
      {/* <section id="advertise" className="mt-20 flex items-center justify-center">
        <iframe title="og:title" src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fnepalicongresshq%2Fposts%2Fpfbid02ZpXqqynmKJKeymkVdoAfdLMV3BttTZDCymou62unqyJ7x8JxZhCAHcPtjGRzNaN4l&show_text=true&width=500" width="500" height="680" style={{ border: 'none', overflow: 'hidden' }} scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
      </section> */}
      <section id="ft-to-cm">
       <Counter />
       </section>
